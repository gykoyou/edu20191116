...
//		总数
		...
		System.out.println(pagination.getCursor());
		System.out.println(pagination.getOffset());
		
		List<DeptInfo> list = deptDAO.getDeptList(pagination.getCursor(), pagination.getOffset());
